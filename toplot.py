...
sobelDx = np.gradient(normImgGray, axis=1) # horizontal
...
while cmax > initmaxp*TERMINATION_RATIO:
    ...
    pIdxRow, pIdxCol = divmod(pixIdx, mag.shape[1])
...
# output_image = np.zeros_like(baseImageGray)
# output_image_uint8 = (output_image * 255).astype(np.uint8)

# for y, x in zip(rr, cc):
#     output_image[y, x] = 255  # You can adjust the value for line brightness
# imageio.imwrite("toplot.jpg", output_image_uint8)
